...
const FORMAT_CARDS = [
  {
    ...
    description: 'Renders ramps as diagonal slopes on the dashboard. Best visual preview and execution for smart trainers.',
    pros: [
      'Ramps shown as diagonal slope on dashboard',
      'Warmup / cooldown with correct directional icon',
      'Supported by Zwift, TrainerRoad, Rouvy, FulGaz',
    ],
    note: null,
    devices: ['Hammerhead Karoo 2/3/+', 'Zwift', 'TrainerRoad', 'Rouvy', 'FulGaz'],
  },
  {
    id: 'fit',
    ext: '.FIT',
    ...
    description: 'Universal binary standard. All ramps appear as flat power ranges on the dashboard — execution is still correct on device.',
    pros: [
      'Works on virtually any cycling computer',
      'ANT+ FE-C smart trainers (Wahoo, Garmin…)',
      'No app required — just load the file',
    ],
    note: 'Hammerhead renders all steps as flat blocks — no diagonal ramp visuals.',
    devices: ['Garmin Edge (all)', 'Wahoo ELEMNT / BOLT / ROAM', 'Hammerhead Karoo', 'Bryton', 'ANT+ FE-C trainers'],
  },
];
